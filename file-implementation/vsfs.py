...
parser.add_option('-i', '--numInodes',   default=8,     help='文件系统中的inode数',      action='store', type='int', dest='numInodes') 
parser.add_option('-d', '--numData',     default=8,     help='文件系统中的数据块数', action='store', type='int', dest='numData') 
