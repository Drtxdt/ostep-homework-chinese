...
parser.add_option('-a', '--allocated', default=64, help='分配的虚拟页数',
                  action='store', type='int', dest='allocated')
parser.add_option('-n', '--addresses', default=10, help='要生成的虚拟地址数',
                  action='store', type='int', dest='num')
parser.add_option('-c', '--solve', help='为我计算答案', action='store_true', default=False, dest='solve')
