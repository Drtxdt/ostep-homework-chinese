...
parser.add_option('-d', '--data_size', default='4', help='数据字中的字节数', action='store', type='int', dest='data_size')
parser.add_option('-D', '--data', default='', help='逗号分隔形式的数据', action='store', type='string', dest='data')
