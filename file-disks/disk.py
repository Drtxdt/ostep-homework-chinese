...
parser.add_option('-a', '--addr',            default='-1',        help='请求列表（逗号分隔）[-1 -> 使用 addrDesc]',     action='store', type='string', dest='addr')
...
parser.add_option('-z', '--zoning',          default='30,30,30',  help='外部、中间、内部磁道上的块间角度',      action='store', type='string', dest='zoning')
...
parser.add_option('-c', '--compute',         default=False,       help='计算答案',                                     action='store_true',           dest='compute')
