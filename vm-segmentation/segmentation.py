...
parser.add_option("-b", "--b0", default="-1", help="段0基寄存器的值", action="store", type="string", dest="base0")
parser.add_option("-l", "--l0", default="-1", help="段0限度寄存器的值", action="store", type="string", dest="len0")
parser.add_option("-B", "--b1", default="-1", help="段1基寄存器的值", action="store", type="string", dest="base1")
parser.add_option("-L", "--l1", default="-1", help="段1限度寄存器的值", action="store", type="string", dest="len1")
